...
<div class="flex">
<svg class="h-4 w-4 fill-indigo-600 dark:fill-sky-300" version="1.1" id="RSS" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
<p class="ml-0.5 text-indigo-600 dark:text-sky-300 text-[0.5rem] font-medium">RSS</p>
</div>
</a>